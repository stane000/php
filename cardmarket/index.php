...
<body>
	...
	# Cards webpage
	else if ($menu == 8) { include("Cards.php"); }

	# Profile webpage
	else if ($menu == 9) { include("profile.php"); }

	#add card
	else if ($menu == 10) { include("add_card.php"); }

	#eddit profile
	else if ($menu == 11) { include("eddit_profile.php"); }

	#weather
	else if ($menu == 13) { include("w2.php"); }

	#buy
	else if ($menu == 14) { include("buy_card.php"); }
	
	
	print '
	</main>
	<footer>
		<p>Copyright &copy; ' . date("Y") . ' Igor Stankovic</p>
	</footer>
</body>
</html>';
?>
